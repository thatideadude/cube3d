...
// Amostra textura de acordo com coordenadas do mundo
...
// Retorna cor do teto para coord de tela
...
// Retorna cor do piso para coord de tela
...
// Dispatcher que retorna cor de piso ou teto conforme is_ceiling
