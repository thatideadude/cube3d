...
int key_press(int keycode, t_game *game)
{
    if (keycode == 65307) 
    {
         mlx_destroy_window(game->mlx_ptr, game->win_ptr); exit(0);
    }
    ...
    else if (keycode == 65361) game->keys.left_arrow = 1;
    else if (keycode == 65363) game->keys.right_arrow = 1;
    return (0);
}
...
int key_release(int keycode, t_game *game)
{
    ...
    else if (keycode == 65361) game->keys.left_arrow = 0;
    else if (keycode == 65363) game->keys.right_arrow = 0;
    return (0);
}
